            ...
            if (result != null && result.results.Length > 0)
            {
                foreach (var res in result.results)
                {
                    foreach (var alt in res.alternatives)
                    {
                        ...
                        if (alt.transcript.Contains("pink"))
                        {
                            faceMeshRenderer = GameObject.Find("FaceMesh").GetComponent<MeshRenderer>();
                            if (faceMeshRenderer == null)
                            {
                                Debug.LogError("FaceMesh not found.");
                            }
                            faceMeshRenderer.material = red_sphere;
                        }
                        else if (alt.transcript.Contains("green"))
                        {
                            ...
                            faceMeshRenderer.material = green_sphere;
                        }
                        else if (alt.transcript.Contains("yellow"))
                        {
                            ...
                            faceMeshRenderer.material = yellow_sphere;
                        }
                    }
